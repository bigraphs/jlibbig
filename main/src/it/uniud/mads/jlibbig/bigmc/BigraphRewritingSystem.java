...
/**
 * This class stores a set of bigraphs and a set of reactions. It also stores
 * the set of outernames that aren't free names in the reactions. Bigraphs,
 * redexes and reacta of the same system share the same signature and this
 * signature (system's signature) can't change.
 */
public class BigraphRewritingSystem {
	 ...
	 * 
	 * @param name
	 *            name (string) that will be added to the list.
	 */
	 ...
	 * @throws RuntimeException
	 *             if signatures don't match or if redex and reactum don't have
	...
	/**
	 * Add a reaction to the system. Reaction's signature must match the
	 * system's signature.
	 * 
	 * @param rule
	 *            rewriting rule.
