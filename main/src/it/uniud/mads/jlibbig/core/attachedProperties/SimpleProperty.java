...
public class SimpleProperty<V> extends Property<V> {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.uniud.mads.jlibbig.core.AttachedProperty#isReadOnly()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.uniud.mads.jlibbig.core.AttachedProperty#registerListener(jlibbig.core.
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.uniud.mads.jlibbig.core.AttachedProperty#unregisterListener(jlibbig.core.
	 * AttachedPropertyListener)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.uniud.mads.jlibbig.core.AttachedProperty#get()
	 */
	@Override
	public V get() {
		return value;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.uniud.mads.jlibbig.core.AttachedProperty#set(V)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see it.uniud.mads.jlibbig.core.AttachedProperty#getName()
	 */
	@Override
