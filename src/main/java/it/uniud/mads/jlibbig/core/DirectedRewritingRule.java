 ...
 *            
 * @see DirectedRewritingSystem
 */
public interface DirectedRewritingRule<A extends DirectedBigraph<?>, 
		B extends DirectedBigraph<?>> extends DirectedReactionRule<A> {
	/**
	 ...
	 */
	public DirectedInstantiationRule<? extends A> getInstantiationRule();
}
