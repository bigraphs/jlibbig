...
public class BigMCPrinter{
	private BigMCPrinter(){}
	
	public static String toString( BigraphSystem brs ){
		...
		for(Map.Entry<RedexBigraph, RedexBigraph> reaction : brs.getReactions().entrySet() )
			s.append( toString( reaction.getKey().getBigraph() ) + " -> " + toString( reaction.getValue().getBigraph() ) + " ;" + ln );
