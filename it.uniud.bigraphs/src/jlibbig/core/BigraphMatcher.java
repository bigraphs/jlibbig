			...
			private void populateMatchQueue(boolean first) {
				...
				do {
					...
					do {
						...
						EditableSite ctx_sites_dic[] = new EditableSite[redex_roots.size()];
						EditableSite rdx_sites_dic[] = new EditableSite[redex_sites.size()];
						EditableSite prm_sites_dic[] = new EditableSite[agent_sites.size()];
