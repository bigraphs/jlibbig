...
public class ReplicatingProperty<V> extends SimpleProperty<V> {
    ...
    @SafeVarargs
	public ReplicatingProperty(String name, PropertyListener<? super V>... listeners) {
		super(name, listeners);
	}

    @SafeVarargs
	public ReplicatingProperty(String name, V value, PropertyListener<? super V>... listeners) {
