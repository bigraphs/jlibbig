 ...
 * from the grammar specification "brs_parser.grammar".
 */
public class BRSParser extends Parser {
	...
	public BRSParser() {
		...
		actions = new Action[] {
			...
			new Action() {	// [2] definitionlist = definitions.sb MODE.m VARID.v COLON num.n SEMICOLON
				public Symbol reduce(Symbol[] _symbols, int offset) {
			...
			new Action() {	// [4] definitions = definitions.sb MODE.m VARID.v COLON num.n SEMICOLON
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_sb = _symbols[offset + 1];
					final SignatureBuilder sb = (SignatureBuilder) _symbol_sb.value;
					final Symbol _symbol_m = _symbols[offset + 2];
			...
			new Action() {	// [6] models = models big.r REACT big.s SEMICOLON
				public Symbol reduce(Symbol[] _symbols, int offset) {
			...
			new Action() {	// [7] models = models big.r REACT big.s PERCENT eta.et SEMICOLON
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_r = _symbols[offset + 2];
					final ParsedBigraph r = (ParsedBigraph) _symbol_r.value;
					final Symbol _symbol_s = _symbols[offset + 4];
			...
			new Action() {	// [13] big = TAGOPEN voidorname.x SLASH namesnonull.l TAGCLOSE
				public Symbol reduce(Symbol[] _symbols, int offset) {
			...
			new Action() {	// [14] big = TAGOPEN voidorname.x SLASH namesnonull.l TAGCLOSE big.b
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_x = _symbols[offset + 2];
					final NameId x = (NameId) _symbol_x.value;
					final Symbol _symbol_l = _symbols[offset + 4];
			...
			new Action() {	// [18] big = ZERO
				public Symbol reduce(Symbol[] _symbols, int offset) {
					 return new Symbol( new ParsedBigraph( _sys.getSignature() ) );
				}
			},
			...
			new Action() {	// [25] notemptyeta = num.n COMMA notemptyeta.l
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_n = _symbols[offset + 1];
					final int n = (int) _symbol_n.value;
					final Symbol _symbol_l = _symbols[offset + 3];
			...
			new Action() {	// [34] notemptynamesnonull = name.n COMMA notemptynamesnonull.l
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_n = _symbols[offset + 1];
					final NameId n = (NameId) _symbol_n.value;
					final Symbol _symbol_l = _symbols[offset + 3];
			...
			new Action() {	// [39] notemptynames = name.n COMMA notemptynames.l
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_n = _symbols[offset + 1];
					final NameId n = (NameId) _symbol_n.value;
					final Symbol _symbol_l = _symbols[offset + 3];
			...
			new Action() {	// [40] notemptynames = DASH COMMA notemptynames.l
				public Symbol reduce(Symbol[] _symbols, int offset) {
					final Symbol _symbol_l = _symbols[offset + 3];
					final LinkedList<NameId> l = (LinkedList<NameId>) _symbol_l.value;
